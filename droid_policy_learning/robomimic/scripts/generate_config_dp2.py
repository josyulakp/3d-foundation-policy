...
parser.add_argument('--algo', type=str, default='dp2', help="Algorithm name")
...
def main():
    ...
    config = json.load(open(os.path.join(robomimic.__path__[0], "exps/templates/diffusion_policy.json"), 'r'))
