...
def optimizer_from_optim_params(net_optim_params, net):
    ...
    # trained_params = [param for param in net.parameters() if param.requires_grad]
...
def backprop_for_loss(net, optim, loss, accelerator, max_grad_norm=2.0, retain_graph=False):
    """
    ...
    #     accelerator.clip_grad_norm_(net.parameters(), max_grad_norm)
