...
def collect_data_folderpaths(filter_func=None, remove_failures=True):
    ...
    data_dir = os.path.join(dir_path, "/home/aa/rujiayang/droid/droid/user_interface/data/success/2025-02-15")
    # if remove_failures:
    #     data_dir = os.path.join(data_dir, "success")

    #TODO:2024-8-15 debug
    # data_dir = os.path.join(data_dir,"2025-01-17-clean")
