...
standard_params = dict(
    depth_minimum_distance=0.1, camera_resolution=sl.RESOLUTION.HD720, depth_stabilization=False, camera_fps=15, camera_image_flip=sl.FLIP_MODE.OFF, camera_disable_self_calib=True
)

advanced_params = dict(
    depth_minimum_distance=0.1, camera_resolution=sl.RESOLUTION.HD2K, depth_stabilization=False, camera_fps=15, camera_image_flip=sl.FLIP_MODE.OFF, camera_disable_self_calib=True
)
...
class ZedCamera:
    ...
    def _configure_camera(self, init_params):
        ...
        sl_params.depth_mode = sl.DEPTH_MODE.ULTRA 
